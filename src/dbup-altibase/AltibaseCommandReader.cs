...
{
    public class AltibaseCommandReader : SqlCommandReader
    {
        const string DelimiterKeyword = "DELIMITER";

        /// <summary>
        /// Creates an instance of AltibaseCommandReader
        /// </summary>
        public AltibaseCommandReader(string sqlText) : base(sqlText, "/", delimiterRequiresWhitespace: false)
        {
        }
